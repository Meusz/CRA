...
(define concatenar
  (lambda (lst1)    ;Lista1
    (lambda(lst2)   ;Lista2
      ...
      lst1)
        lst2) ; Pasa l como el valor inicial de x.
    ))
...
(define pertenece
  (lambda (lst)    ;Lista
    (lambda(elem)   ;elemento
      ...
      lst)
        elem) ; Pasa l como el valor inicial de x.
    ))
          ...
          (((vacia? x)
            ...
            (lambda (no_use)
              ...
              ( ((esigualent elem) (cabeza x));;Condicion
                ...
                (     (concatenar (  (construir (cabeza x)) vacia) )
         ...
         (lambda (x)
          ...
          (( (vacia? x)
            ...
            (lambda (no_use)
              ...
              (     (concatenar (  (construir (min_lista x)) vacia) )
 ...
 (lambda (l1)
  ...
  (lambda (l2)
   ...
   (
    ...
    ((neg ((esigualnat (longitud l1)) (longitud l2)))
      ...
      (((Y (lambda (f)  ;Operadoe de punto fijo sobre la funcion f de argumento x
         (lambda (x)
          ...
          (((vacia? x)
            ...
            (lambda (no_use)
              ( ((esigualnat (longitud x)) (longitud y));;Condicion
