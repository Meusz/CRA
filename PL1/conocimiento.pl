...
no_gafas(['Paul','Tom','Derek','Richard','Louis','Sam','Steve','Will','Billy','Henry','Tiffany','Roxanne','Sarah','Cindy', 'Emma']).

preguntas(['chico','chica','pelo_rubio','pelo_negro','ropa_roja','ropa_verde','feliz','triste','ojos_azules','ojos_marrones','gafas','no_gafas'])
